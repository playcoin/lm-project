...
train_text = readClearFile("./data/datasets/pku_ner_train.ltxt")
train_tags = readFile("./data/datasets/pku_ner_train_tag.ltxt") # 不要清空格

test_text = readClearFile("./data/datasets/pku_ner_test.ltxt")
test_tags = readFile("./data/datasets/pku_ner_test_tag.ltxt") # 不要清空格

rnnner = RnnNER(nlpdict, n_emb=200, n_hidden=1200, lr=0.5, batch_size=156, 
...
def main():
	...
	rnnner.traintext(train_text, train_tags, '\n'.join(lines), '\n'.join(tlines), 
