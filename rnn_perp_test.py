...
# 		batch_size=40, 
# 		truncate_step=4, 
# 		backup_file_path="./data/RnnLM/RnnLM.model.epoch49.n_hidden140.truncstep6.obj"
# 	)
...
rnnlm = RnnEmbTrLM(nlpdict, n_hidden=800, lr=0.5, batch_size=100, truncate_step=4, 
		...
		backup_file_path="./data/RnnEmbTrLM/RnnEmbTrLM.model.epoch29.n_hidden800.ssl20.truncstep4.drTrue.obj"
	)
